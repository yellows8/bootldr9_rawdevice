...
ifneq ($(strip $(ENABLE_CONTINUEWHEN_PAYLOADCALLFAILS)),)
	DEFINES	:=	$(DEFINES) -DENABLE_CONTINUEWHEN_PAYLOADCALLFAILS
endif
...
ifneq ($(strip $(DEVICEDISABLE_SPIFLASH)),)
	DEFINES	:=	$(DEFINES) -DDEVICEDISABLE_SPIFLASH
endif
...
ifneq ($(strip $(PADCHECK_DISABLEDEVICE_SPIFLASH)),)
	DEFINES	:=	$(DEFINES) -DPADCHECK_DISABLEDEVICE_SPIFLASH=$(PADCHECK_DISABLEDEVICE_SPIFLASH)
endif

ifneq ($(strip $(PADCHECK_ENABLEDEVICE_SPIFLASH)),)
	DEFINES	:=	$(DEFINES) -DPADCHECK_ENABLEDEVICE_SPIFLASH=$(PADCHECK_ENABLEDEVICE_SPIFLASH)
endif
